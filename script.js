const store = new Vuex.Store({
  state: {
    // initial state
    servers: [
    { name: 'Сеньорита гитара', status: false, adr: '192.168.0.24' },
    { name: 'Metaus', status: false, adr: '192.168.0.25', type: 'database' },
    { name: 'Yandex', status: true, adr: '192.168.0.26', type: 'database' },
    { name: 'Yandex Reserv Server', status: true, adr: '192.168.0.37' },
    { name: 'vass.by', status: false, adr: '192.168.0.17' },
    { name: 'vaaa.ru', status: false, adr: '192.168.0.23' }] },
